    ...
    return(
        <>
            ...
            {courseDetail.map((data) => {
                return(
                    <CourseDetailComponent key={data.id} id={data.id} title={data.title} rating={data.rating} difficulty={data.difficulty} time={data.time} description={data.description} detailDescription={data.detail_description} tech={data.tech} total={data.total_student}/>
                    )
                })}
            <FooterComponent />
        </>
