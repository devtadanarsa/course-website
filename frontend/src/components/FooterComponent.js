...
export default function FooterComponent() {
  return (
    <div className="bg-[#F2BF62] text-white">
      ...
      <p className="text-[16px] font-bold flex justify-center mt-32">
        Copyright &copy; 2023. Created with love
      </p>
      <p className="text-[16px] font-bold flex justify-center mt-4 pb-20">
        by Devta and Tude Prayatna
      </p>
    </div>
  );
}
